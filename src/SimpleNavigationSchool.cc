  ...
  theBarrelLength(0),theField(field), theTracker(theInputTracker)
{
  ...
  //above seems fragile and causing crashes when I make the needed SLHC changes (in 2_2_X)
  //seems to be using a temporary memory location so we will change this (did not recheck in 3_3_X if still fragile)
